    ...
    *  in HP Service Test.
    ...
    {    
        ...
        internal void InitializeComponent()
        {
            ...
            _flow.dataSourceNameToDataSource.Add("FlightCities!Sheet1", _flow.DataFetchActivity7);
            ...
            _flow.DataExporterActivity9.InDirections.Add(bind_dir4);
            ...
            _flow.DataDisconnectActivity8.InDirections.Add(bind_dir5);
            ...
            this.DataCursorActivity11.InDirections.Add(bind_dir6);
...
@"<Envelope xmlns=""http://schemas.xmlsoap.org/soap/envelope/""><Body><GetFlights xmlns=""HP.SOAQ.SampleApp""><DepartureCity>{DataSource.FlightCities!Sheet1.Departure City}</DepartureCity><ArrivalCity>{DataSource.FlightCities!Sheet1.Arrival City}</ArrivalCity><FlightDate>2024-07-20T00:00:00+00:00</FlightDate></GetFlights></Body></Envelope>");
            ...
            VTDPropertyInfoBase pi13 = new VTDPropertyInfoBase("Departure City");
            ...
            binding_setter7 = new StringFormaterDecorator(binding_setter7,"{DataSource.FlightCities!Sheet1.Departure City}");
            bind_dir7 = new BindDirection(this.DataCursorActivity11,binding_getter7,binding_setter7,BindTargetType.ToInProperty);
            _flow.StServiceCallActivity4.InDirections.Add(bind_dir7);
            VTDPropertyInfoBase pi15 = new VTDPropertyInfoBase("Arrival City");
            ...
            binding_setter8 = new StringFormaterDecorator(binding_setter8,"{DataSource.FlightCities!Sheet1.Arrival City}");
            bind_dir8 = new BindDirection(this.DataCursorActivity11,binding_getter8,binding_setter8,BindTargetType.ToInProperty);
