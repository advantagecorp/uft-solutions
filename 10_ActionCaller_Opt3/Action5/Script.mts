...
WpfWindow("OpenText MyFlight Sample").WpfEdit("passengerName").Set DataTable("p_AgentName", dtGlobalSheet) @@ hightlight id_;_1997141616_;_script infofile_;_ZIP::ssf15.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfButton("ORDER").Click @@ hightlight id_;_1997150544_;_script infofile_;_ZIP::ssf16.xml_;_
wait 5
WpfWindow("OpenText MyFlight Sample").WpfObject("Order 182 completed").Check CheckPoint("Order completed")
WpfWindow("OpenText MyFlight Sample").WpfObject("Order 182 completed").Output CheckPoint("OutputOrderNumber")
WpfWindow("OpenText MyFlight Sample").WpfObject("Order 182 completed").Output CheckPoint("CheckOrderNum")
WpfWindow("OpenText MyFlight Sample").WpfButton("NEW SEARCH").Click
WpfWindow("OpenText MyFlight Sample").WpfTabStrip("WpfTabStrip").Select "SEARCH ORDER" @@ hightlight id_;_2141659104_;_script infofile_;_ZIP::ssf18.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfRadioButton("byNumberRadio").Set @@ hightlight id_;_1948691928_;_script infofile_;_ZIP::ssf30.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfEdit("byNumberWatermark").Set DataTable("outOrderNum", dtLocalSheet) @@ hightlight id_;_1942393544_;_script infofile_;_ZIP::ssf31.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfButton("SEARCH").Click @@ hightlight id_;_1942393592_;_script infofile_;_ZIP::ssf32.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfButton("NEW SEARCH").Click
