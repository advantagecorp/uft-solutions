...
flyFromCity = WpfWindow("OpenText MyFlight Sample").WpfComboBox("fromCity").GetROProperty("selection")
...
flyToCity = WpfWindow("OpenText MyFlight Sample").WpfComboBox("toCity").GetROProperty("selection")
...
x = GetLastError
print(DescribeResult(x))
If x = 0 Then
	print "Order successfully created from " & flyFromCity & " to " & flyToCity & "."
Else
...
'For i = 0 To citiesCount - 1 
'WpfWindow("OpenText MyFlight Sample").WpfComboBox("fromCity").Select i
'	For j = 0 To citiesCount - 1 
'		WpfWindow("OpenText MyFlight Sample").WpfComboBox("toCity").Select j
'	Next
'Next
