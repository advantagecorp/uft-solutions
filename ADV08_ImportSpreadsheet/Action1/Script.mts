DataTable.ImportSheet "C:\Users\demo\Documents\UFT One\testdata.xlsx", "Sheet1", 1
fromCity = DataTable("p_fromCity", dtGlobalSheet)
toCity = DataTable("p_toCity", dtGlobalSheet)
...
WpfWindow("OpenText MyFlight Sample").WpfComboBox("toCity").Select toCity @@ hightlight id_;_1950404432_;_script infofile_;_ZIP::ssf4.xml_;_
